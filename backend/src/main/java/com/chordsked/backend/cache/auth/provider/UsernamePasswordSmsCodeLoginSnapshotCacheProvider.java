...
/**
 * 账号密码加短信验证码登录快照缓存 provider。
 * 当前仅保留基础声明，待账号密码验证码登录正式开放后再补充具体缓存读写逻辑。
 */
@Component("usernamePasswordSmsCodeLoginSnapshotCacheProvider")
public class UsernamePasswordSmsCodeLoginSnapshotCacheProvider implements AuthLoginSnapshotCacheProvider {
    @Override
