...
CREATE INDEX IF NOT EXISTS idx_sys_internal_user_is_deleted ON sys_internal_user(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_campus_is_deleted ON sys_campus(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_teacher_user_is_deleted ON sys_teacher_user(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_student_user_is_deleted ON sys_student_user(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_user_campus_is_deleted ON sys_user_campus(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_operation_log_is_deleted ON sys_operation_log(is_deleted);
...
CREATE INDEX IF NOT EXISTS idx_sys_sms_code_phone ON sys_sms_code(phone);
CREATE INDEX IF NOT EXISTS idx_sys_sms_code_expire_at ON sys_sms_code(expire_at);
